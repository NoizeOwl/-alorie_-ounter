...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/scriptcopy.js":[function(require,module,exports) {
...
resultBut.addEventListener("click", function (evt) {
  ...
  console.log(weight);
  var res = Math.ceil(10 * weight.value + 6.25 * height.value - 5 * age.value + rate);
  console.log(res);
  var final = res * k;
  console.log(final);
  results.classList.remove("counter__result--hidden");
  caloriesNorm.textContent = final;
  caloriesMin.textContent = Math.ceil(final - final * 0.15);
  caloriesMax.textContent = Math.ceil(final + final * 0.15);
});
...
},{}]},{},["../../../AppData/Roaming/nvm/v16.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/scriptcopy.js"], null)
//# sourceMappingURL=/scriptcopy.d9217eb1.js.map